...
public class Register extends javax.swing.JFrame {
  ...
  ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        jDatechooser_BDATE = new javax.swing.JTextField();
        ...
        jDatechooser_BDATE.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jDatechooser_BDATE.setForeground(new java.awt.Color(228, 241, 254));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jDatechooser_BDATE, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(146, 146, 146)
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
       ...
       String fistname = jTextField_FN.getText();
       String lastname = jTextField_LN.getText();
       String username = jTextField_UN.getText();
       String password = jPasswordField_PASS.getText();
       String confirm_password =  jPasswordField_REPASS.getText();
       String age= jDatechooser_BDATE.getText();
       String address= jTextArea_ADDRESS.getText();

     
        try{         
 
           String q = "INSERT INTO `users` (`u_fname`, `u_lname`, `u_uname`, `u_pass`, `u_copass`, `u_bdate`, `u_address`)VALUES ('"+fistname+"','"+lastname+"','"+username+"','"+password+"','"+confirm_password+"','"+age+"','"+address+"')";
    ...
    private javax.swing.JTextField jDatechooser_BDATE;
